...
\node[font=\Large, anchor=west] at (19,26) {\textcolor{black}{Konvolucija (3x3)}};

\filldraw[fill=\BatchNorm] (19,25) ++(-0.5,0) circle (0.2);
\node[font=\Large, anchor=west] at (19,25) {\textcolor{black}{Normalizacija Grupe}};

\filldraw[fill=\Relu] (19,24) ++(-0.5,0) circle (0.2);
\node[font=\Large, anchor=west] at (19,24) {\textcolor{black}{ReLu funkcja}};

\filldraw[fill=\FcColor] (25,26) ++(-0.5,0) circle (0.2);
\node[font=\Large, anchor=west] at (25,26) {\textcolor{black}{Linearni sloj}};

\filldraw[fill=\DropoutColor] (25,25) ++(-0.5,0) circle (0.2);
\node[font=\Large, anchor=west] at (25,25) {\textcolor{black}{Izostavljanje(0.5)}};
