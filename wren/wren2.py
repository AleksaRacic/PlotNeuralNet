...
arch = [
    ...
    to_colored_box("embedded1", 1, offset="(0,0,0)", to="(0,0,0)", height=10//factor, depth=40//factor, width=10//factor , caption="Spojeni parovi latentnih vektora", color=color1),
    ...
    to_colored_box("embedded12", 1, offset="(0,3,0)", to="(0,0,0)", height=10//factor, depth=40//factor, width=10//factor , caption="", color=color1),
    ...
    to_colored_box("embedded13", 1, offset="(0,6,0)", to="(0,0,0)", height=10//factor, depth=40//factor, width=10//factor , caption="", color=color2),
    ...
    to_vertical_dots("(2,9)"),

    to_text("9,9", "Deep FunctionG "),

    to_text("31,6", "Deep FunctionG "),

    to_colored_box("embedded132", 1, offset="(0,14,0)", to="(0,0,0)", height=10//factor, depth=40//factor, width=10//factor , caption="", color=color2),
    ...
    to_colored_box("embedded1321", 1, offset="(0,17,0)", to="(0,0,0)", height=10//factor, depth=40//factor, width=10//factor , caption="", color=color3),
    ...
    to_colored_box("embedded1322", 1, offset="(0,20,0)", to="(0,0,0)", height=10//factor, depth=40//factor, width=10//factor , caption="", color=color3),
    ...
    to_Sum("sum1", offset="(23,9,0)", to="(0,0,0)", radius=3.5, opacity=0.6),
    ...
    to_Linear("linear127420", 256, offset="(2,0,0)", to="(embedded3233-east)", height=40//factor, depth_width=2 , caption=""),
    to_connection( "embedded3233", "linear127420"),
    to_ReLu("relu127420", 256, offset="(0,0,0)", to="(linear127420-east)", height=40//factor, width=2, depth=2, caption=""),
    to_Linear("linear127420", 256, offset="(2,0,0)", to="(relu127420-east)", height=40//factor, depth_width=2 , caption=""),
    to_connection( "relu127420", "linear127420"),
    to_ReLu("relu127420", 256, offset="(0,0,0)", to="(linear127420-east)", height=40//factor, width=2, depth=2, caption=""),
    to_Dropout("Dropout60", to="(relu127420-east)", offset="(2,0,0)", height=40//factor,depth_width=2, caption=""),
    to_connection( "relu127420", "Dropout60"),
    to_ReLu("relu127430", 256, offset="(2,0,0)", to="(Dropout60-east)", height=2, width=2, depth=2, caption="Score"),
    to_connection( "Dropout60", "relu127430"),
